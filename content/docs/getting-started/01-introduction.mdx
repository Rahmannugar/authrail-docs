...
**AuthRail** is a deterministic, framework-agnostic policy engine built for the modern web. It allows you to define, test, and execute authorization logic with complete type safety.
...
- **Framework Agnostic**: Works in Next.js, Remix, Express, Cloudflare Workers, or generic Node.js.
...
Ready to build? Check out the [Quick Start](/docs/getting-started/quick-start) guide.
