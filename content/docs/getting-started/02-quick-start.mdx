...
- [Middleware](/docs/core/middleware) - Learn about built-in middleware.
- [Custom Rails](/docs/core/rails) - Create your own custom logic.
- [Integrations](/docs/integrations/nextjs) - See how to use AuthRail with Next.js.
