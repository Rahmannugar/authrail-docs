...
<CodeBlock title="lib/auth.ts">
  <Pre>{`import { createRail, requireAuth, requireRole } from "authrail";
...
<CodeBlock title="app/admin/page.tsx">
  <Pre>{`import { adminRail } from "@/lib/auth";
...
- [Middleware](/docs/middleware) - Learn about built-in middleware.
- [Advanced Patterns](/docs/advanced-patterns) - Create your own custom logic.
- [React Integration](/docs/react-integration) - See how to use AuthRail with React and Next.js.
