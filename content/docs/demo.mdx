...
**Action**: In the Policy Control Panel, toggle the "Emergency Lockdown" switch.
**Observation**: Watch how even public routes can be instantly protected. This demonstrates how injecting global site state into the AuthAuth context allows for instant, site-wide policy changes.
